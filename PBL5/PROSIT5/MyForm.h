...
namespace PROSIT5 {
	...
	/// </summary>
	public ref class MyForm : public System::Windows::Forms::Form	// problème 3
	{
	public:
		MyForm(void)
		{
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->btn_first->Click += gcnew System::EventHandler(this, &MyForm::btn_first_Click);	// problème 4
			   //
				// btn_previous
				// 
...
#pragma endregion
	...
	private: System::Void btn_source_Click(System::Object^ sender, System::EventArgs^ e)		// problème 5
	{
		int i;

		this->svcFichier = gcnew NS_services::CLserviceFichier();		// problème 6
		...
		if (this->listeDeFichier->Length > this->index && this->index >= 0) {	// erreur si dossier vide
	...
	{
		this->index = 0;
		if (this->listeDeFichier->Length > this->index) {	// erreur si dossier vide
			this->pctBx->Image = image->lireImage(this->listeDeFichier[this->index]);
		}
	}
	...
	{
		if (pctBx->Image != nullptr) {		// problème 7 
			delete pctBx->Image;			// problème 7
			pctBx->Image = nullptr;			// problème 7 
		}									// problème 7
		...
		else if (this->rdb_effacer->Checked == true)																	// problème 8 
		{																												// problème 8 
			this->svcFichier->effacer(this->listeDeFichier);															// problème 8
			this->txt_rslt->Text = "Les fichiers ont été supprimés depuis l'emplacement : " + this->txt_source->Text;	// problème 8 
		}																												// problème 8 
